<div class="uix-field-wrapper">
	<ul class="ui-tab-nav">
		...
		<?php if ( class_exists( 'LSX_Landing_pages' ) ) { ?>
			...
			<li><a href="#ui-landing" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Landing Pages', 'text_domain' ); ?></a></li>
		<?php } ?>
	</ul>
	...
	<?php if ( class_exists( 'LSX_Landing_pages' ) ) { ?>
		<?php $class_active = ( class_exists( 'LSX_Banners' ) || class_exists( 'LSX_Currencies' ) || class_exists( 'LSX_Team' ) || class_exists( 'LSX_Testimonials' ) || class_exists( 'LSX_Projects' ) || class_exists( 'LSX_Services' ) || class_exists( 'LSX_Blog_Customizer' ) || class_exists( 'LSX_Sharing' ) || class_exists( 'LSX_Videos' ) || class_exists( 'LSX_Search' ) ) ? '' : 'active' ?>
		<div id="ui-landing-apges" class="ui-tab <?php echo esc_attr( $class_active ) ?>">
			<table class="form-table">
				<tbody>
					<?php do_action( 'lsx_framework_display_tab_content', 'landing-pages' ); ?>
				</tbody>
			</table>
		</div>
	<?php } ?>
